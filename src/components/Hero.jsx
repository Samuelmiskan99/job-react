      ...
      <section className='relative bg-gradient-to-r from-blue-600 via-indigo-700 to-purple-700 py-28 mb-4'>
         ...
         <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center'>
            <div className='text-center relative z-10'>
               ...
               <button className='mt-8 bg-white text-indigo-700 font-semibold py-3 px-6 rounded-full shadow-lg hover:bg-indigo-50 transition-transform transform hover:scale-105'>
                  Get Started
               </button>
            </div>
         </div>
